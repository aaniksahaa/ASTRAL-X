 ...
 *
 * <p>All scores in ASTRAL-X are non-negative; the signed representation is used
...
public final class Int128 {
    ...
    public Int128 mulScalar(long f) {
        Int128 loPart = mulLong(this.lo, f);     // 128-bit product of low word
        long hiAdd = this.hi * f;                // high word contribution (fits 64 here)
        return new Int128(loPart.hi + hiAdd, loPart.lo);
    }
