...
public final class TreeRestrictor {
     ...
     * arrays against {@code targetRegistry}. Trees with fewer than four retained
     * taxa are dropped because they contain no quartet and therefore contribute
    ...
    public static GeneResult restrictGeneTrees(List<Tree> sourceTrees,
        ...
        if (restricted.isEmpty()) {
            throw new IllegalArgumentException(
                "No gene tree retains at least four taxa after applying the taxa file");
        }
    ...
    public static Tree restrictSpeciesTree(Tree source,
        ...
        if (restricted == null || restricted.leafCount < 4) {
            throw new IllegalArgumentException(
                "Species tree retains fewer than four scoring taxa after applying the taxa file");
        }
