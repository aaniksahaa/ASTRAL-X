#!/usr/bin/env python3
"""
Independent Python implementation of the ASTRAL-X distance matrix computation.
...
Output: same format as ASTRAL-X --verify-distance-matrix
  DISTANCE_MATRIX
  n=<count>
  taxa=name0,name1,...
  row0=d00,d01,...
